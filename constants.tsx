...
export const MOCK_ATTENDANCE: AttendanceRecord[] = [
  { id: 'a1', date: t(0), studentId: '1', status: AttendanceStatus.S, note: 'Sakit Demam', recordedBy: 'Ustadzah Fatmawati', class: '11 IPA', sessionType: SessionType.MADRASAH, subject: 'Fisika Terapan' },
  { id: 'a2', date: t(0), studentId: '2', status: AttendanceStatus.T, note: 'Telat 10 Menit', recordedBy: 'Ustadz Ahmad Rifa\'i', class: '7A', sessionType: SessionType.MADRASAH, subject: 'Fiqih Wadlih' },
  { id: 'a3', date: t(1), studentId: '5', status: AttendanceStatus.A, note: 'Alpha', recordedBy: 'Ustadz Zulkifli', class: '8B', sessionType: SessionType.MADRASAH, subject: 'Nahwu Jurumiyah' },
  { id: 'a4', date: t(2), studentId: '3', status: AttendanceStatus.I, note: 'Izin Pulang (Acara Keluarga)', recordedBy: 'Ustadzah Siti Aminah, M.Pd', class: '10 IPS', sessionType: SessionType.MADRASAH, subject: 'Bahasa Inggris' }
];
